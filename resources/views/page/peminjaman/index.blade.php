...
<td>
    ...
    @elseif($item->status == 'ditolak')
        <span style="background:#dc3545; color:white; padding:5px 12px; border-radius:8px; font-size:12px;">
            ditolak
        </span>
    @else
        <span style="background:#999; color:white; padding:5px 12px; border-radius:8px; font-size:12px;">
            selesai
        </span>
    @endif
</td>
